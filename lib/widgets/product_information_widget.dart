...
class ProductInformationWidget extends StatelessWidget {
  ...
  final double cost;
  final String seller;
  const ProductInformationWidget({Key? key,required this.productName,required this.cost,required this.seller}) : super(key: key);
            ...
            child: RichText(
                text: TextSpan(
                    children: [
                      ...
                      TextSpan(text:seller, style:const TextStyle(color: activeCyanColor,fontSize: 14)),
                    ]
                )
            ),
          )
